...
CELERY_BROKER_URL = f'redis://:{os.getenv("REDIS_PASS")}@{os.getenv("REDIS_HOST")}:6379/1'
CELERY_RESULT_BACKEND = f'redis://:{os.getenv("REDIS_PASS")}@{os.getenv("REDIS_HOST")}:6379/2'
